...
function getEvents(page) {
  ...
  search = 	document.getElementById("searchStr").innerHTML
  ...
  $.ajax({
    ...
    url:"https://app.ticketmaster.com/discovery/v2/events.json?apikey=6ZaPohqMGa8hTm7s3F4nuzmk2J29DzD4&keyword="+search+"&size=5&page="+page,
    async:true,
    dataType: "json",
