...
$sql = "SELECT * FROM orders,ticket WHERE u_id = ".$id." and t_id = ticket.id";
									...
									<div class="col">
										<div class="search_content d-flex flex-row align-items-center justify-content-end">
											<form action="search.php" id="search_container_form" class="search_container_form" method="post">
												<input type="text" name="search" class="search_container_input" placeholder="Search" required="required">
				...
				<div class="row">
					<div class="col">
						<div class="home_content d-flex flex-row align-items-end justify-content-start">
							<div class="current_page">My Page</div>
	...
	<div class="events" style="padding-top:30px;">
        ...
        <div id='events-panel' class="panel panel-primary">
          <div class="panel-heading" style="background-image: linear-gradient(to right, #4867c0, #329fec);">
            <h2>My Tickets</h2> <h6>Your ticket history shown in below</h6>
          </div>
            ...
            <div id="events" class="list-group">
			  ...
			  if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						...
						echo '<p class="list-group-item-text">'.$row["attraction_name"].'</p>';
						echo '<p class="list-group-item-text">'.$row["date"].'</p>';
						echo '<p class="venue">'.$row["type"].'</p>';
						echo '</a>';
					}
				} else {
					echo "There is no ticket purchased.";
				}
			  ?>
            </div>
